"""
Denser sweep of TARGET_VOL and top_pct for walk-forward backtest.
Writes `backtests/sweep_dense_vols.csv`.
"""
...
OUT = os.path.join(BASE, 'backtests', 'sweep_dense_vols.csv')
...
# target_vol grid 0.003..0.01 step 0.001
TARGET_VOL_GRID = [round(x,4) for x in list(np.arange(0.003, 0.0101, 0.001))]
